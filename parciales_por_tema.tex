...
\author{Juan Cristi} % Si quieren poner como autor al Dto. de Matemática - FIUBA, no hay problema.
...
\begin{enumerate}
	...
	\item (21/11/18-T?-3) \red{Este ejercicio incluye temas del TPIII} Dada $f: \mathbb{R}^2\rightarrow\mathbb{R}/ f(x, y)=2x^2y-y^2$, \textbf{determine} y \textbf{grafique} el conjunto $H$ del plano $xy$ en cuyos puntos la función $h=f'_x f'_y$ resulta con valores positivos y \textbf{analice} si $H$ es conexo. 
...
\begin{enumerate}
	...
	0 & \text{ si } (x, y)=(0,0)
	\end{cases}\]
	\b{Analice} si $f$ es continua en $(0,0)$, en base a su conclusión \b{opine} con fundamento si la función puede tener derivadas parciales continuas en un entorno de dicho punto.
